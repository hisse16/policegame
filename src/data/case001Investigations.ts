...
export const CASE_001_CLUES: InvestigationClue[] = [
 ...
 { id:'clue-clock', title:'The kitchen clock is eleven minutes slow', text:'Police arrived at 21:10 while the wall clock showed 20:59. Anna had warned someone not to trust it.', kind:'contradiction', sourceDocumentId:'doc-report' },
 ...
 { id:'clue-e-ward', title:'The old photograph identifies Edward Ward', text:'The person marked in the 1998 photograph is identified as Edward Ward, a former St. Alden caretaker.', kind:'lead', sourceDocumentId:'doc-photograph' },
 { id:'clue-sedan', title:'A dark blue sedan was outside', text:'Helen remembers a dark blue sedan beside the entrance earlier that evening.', kind:'lead', sourceDocumentId:'doc-witness' },
 { id:'clue-plate', title:'The sedan matches Edward Ward', text:'A partial plate, EW-19, matches the blue sedan listed for Edward Ward in the old school maintenance register.', kind:'contradiction', sourceDocumentId:'doc-street' },
 { id:'clue-tyre', title:'A fresh tyre mark places the sedan at the entrance', text:'The tyre impression begins beside the building entrance, consistent with the sedan being present when someone left the flat.', kind:'observation', sourceDocumentId:'doc-street' },
...
export const CASE_001_HYPOTHESES: CaseHypothesis[] = [
 ...
 { id:'hyp-staged', title:'The apartment was staged', description:'Someone created a false timeline and left ordinary belongings behind to make the disappearance appear voluntary.', clueIds:['clue-coat','clue-bag','clue-clock','clue-door','clue-footsteps'], status:'supported' },
 ...
 { id:'hyp-ward', title:'Edward Ward is connected to the disappearance', description:'The archive gives Ward a motive, while the sedan and partial registration place his vehicle at Anna’s building.', clueIds:['clue-e-ward','clue-sedan','clue-plate','clue-tyre','clue-footsteps'], status:'supported' },
];

export const CASE_001_VALID_CONNECTIONS = [
 ['clue-clock','clue-door'], ['clue-door','clue-footsteps'], ['clue-receipt','clue-rain'], ['clue-note','clue-clock'], ['clue-school','clue-blue-ink'], ['clue-photo','clue-e-ward'], ['clue-sedan','clue-footsteps'], ['clue-sedan','clue-plate'], ['clue-plate','clue-e-ward'], ['clue-tyre','clue-sedan'], ['clue-coat','clue-bag'], ['clue-police','clue-coat'],
] as const;
