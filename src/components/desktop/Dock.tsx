...
const PINNED_APPS = [
  'police-records', 'evidence-lab', 'investigation-board', 'investigation-notebook',
  'police-mail', 'investigation-map', 'file-manager', 'terminal', 'browser',
  'text-editor', 'final-deduction', 'settings'
];
