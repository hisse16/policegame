...
import { DISCOVERY_STEPS, STORY_FACTS, UNRESOLVED_QUESTIONS, CONTRADICTIONS, TIMELINE_EVENTS, INVESTIGATION_LEADS } from './storyData';
...
[DISCOVERY_STEPS, STORY_FACTS, UNRESOLVED_QUESTIONS, CONTRADICTIONS, TIMELINE_EVENTS, INVESTIGATION_LEADS].forEach(normalize);
